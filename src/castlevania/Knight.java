...
public class Knight extends Enemy {
	...
	private static final long serialVersionUID = 2139028058682517518L;

	final static int WIDTH = 128, HEIGHT = 128, SPRITEROWS = 2, SPRITECOLS = 7,
			RANGE = 300, ATTACKRANGE = 100;

	static SpriteSheet sheet = new SpriteSheet(
			"spritesheets/enemy_three_spritesheet.png", WIDTH, HEIGHT,
	...
	private final int RUNSPEED = 2, MOVESPEED = 1; //Might change AD
